...
Product Vendor: Sumo Logic <br>
Product Name: Sumo Logic <br>
...
**message_parser** | optional | python_script | Python file containing a message parsing method |
...
[on poll](#action-on-poll) - Run a query on Sumo Logic and ingest the results <br>
[get results](#action-get-results) - Retrieves the result of a search job <br>
[run query](#action-run-query) - Runs a search query on the Sumo Logic platform <br>
